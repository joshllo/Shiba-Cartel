...
Shiba Cartel is set in Queso, a small American town that rubs up against the 
Southern border where the cartels fight to control different neighborhoods. 
Collect different Shibes to grow your cartel & send them on different activities 
such as drug dealing, racketeering & extortion to earn $PESOS and become the 
top canine cartel in Queso.

 Website: https://www.badshibas.com
 Medium: https://medium.com/bad-shibas
 Twitter: https://www.twitter.com/bad-shibas
 Discord: 


https://www.twitter.com/milkie_eth
https://www.t.me/milkie.eth
*/
...
abstract contract Project {
    address public marketingWallet = 0xE2d1F7E035A62043F94A162b70b1181D1027308a;
    address public treasuryWallet = 0xE2d1F7E035A62043F94A162b70b1181D1027308a;

    string constant _name = "Shiba Cartel";
    string constant _symbol = "$PESOS";
    ...
    uint256 public swapMarketing      = 44;
 ...
 * MainContract
 */
contract ShibaCartel is Project, IERC20, Ownable {
